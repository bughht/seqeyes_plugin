...
describe('interactive calculation budgets', () => {
  it('estimates native-raster and ADC work without allocating result arrays', () => {
    ...
    // 104 K candidates and 4 K ADC samples at the measured 1 and 43 bytes, plus
    // the fixed overhead that dominates at this size. This was above 10 MB when
    // the trajectory was materialised at full raster.

...
var m1Data=null,pnsData=null,m1Busy=false,pnsBusy=false,m1RequestedChannel=8,m1ReferenceMode=readM1ReferenceMode();
...
function setM1ReferenceMode(mode){
  ...
  if(shouldRecalc)requestM1(m1RequestedChannel||8);
